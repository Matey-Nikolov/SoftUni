...
namespace Dinner
{
    class StartUp
    {
        ...
        {
            Task<Meat> meat = GrillMeatAsync();
            Task<Vegetables> vegetables = GrillVegetablesAsync();

            List<Task> dinnerTasks = new List<Task> { meat, vegetables };

            await Task.WhenAll(dinnerTasks);

            MakeFruitSalad();
        }
        private static async Task<Meat> GrillMeatAsync()
        {
        ...
        private static async Task<Vegetables> GrillVegetablesAsync()
        {
